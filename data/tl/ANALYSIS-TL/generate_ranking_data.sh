...
multi_en="../../multi/wiki.en.tl.vec"    # /   (root directory)
multi_tl="../../multi/wiki.tl.vec"    # /   (root directory)
if [ -e "$multi_en" -a -e "$multi_tl" ] 
then
...
python src/trans.py --src_lang en --tgt_lang tl --query ../topics/en.t --tquery qmodel/fastext --model multi --src_emb ../../multi/wiki.en.tl.vec --tgt_emb ../../multi/wiki.tl.vec --dico_train ../../dictionary/en-tl.txt 
...
python gen_w2v.py ../../multi/wiki.en.tl.vec word_dict.txt embed_fastext_d300
