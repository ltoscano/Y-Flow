...
python src/gen_w2v.py ../../glove/glove.300.txt data/word_dict.txt embed_fastext_d300
#python src/gen_w2v.py ../../fastext/wiki.en.vec data/word_dict.txt embed_fastext_d300
