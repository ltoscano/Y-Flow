...
parser.add_argument('--query', help='query file', default='../topics/QUERY1/query_list.tsv')
...
def main(opts):
    ...
    #create_new_queries(query_ids, opts.query, new_q)
            ...
            for line in fin:
                ...
                if line[:5] == 'query' and line[:8] != 'query_id':
                    ...
                    if qid in missing_ids:
                        ...
                        for word in words:
                            try:
                                new_words.extend([x for x, sim in word_vectors.most_similar_cosmul(word.lower())[:20]])
                            except:
                                continue
                        #print(words)
                        #print(words)
