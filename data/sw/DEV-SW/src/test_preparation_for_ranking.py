...
#sys.path.append('../')
from yutils.preparation import *
from yutils.preprocess import *
import nltk
...
if __name__ == '__main__':
    ...
    rel_train, rel_valid, rel_test = prepare.split_train_valid_test_for_ranking(rels, [0.95, 0.025, 0.025])
